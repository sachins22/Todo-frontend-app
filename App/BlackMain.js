...
export default function BlackMain() {
  ...
  function GoBlackSetting(){
    navigation.navigate('BlackSetting')
  }
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <View style={styles.textContainer}>
                ...
                <TouchableOpacity style={styles.iconStyle} onPress={GoBlackSetting}>
